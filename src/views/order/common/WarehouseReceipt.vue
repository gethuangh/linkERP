<template>
  <div class="sales-order">
    ...
    >
      ...
      <el-table-column width="75" prop="c" label="销售订单号" align="center">
        <template slot-scope="scope">
      ...
      <el-table-column width="75" prop="i" label="销售单价" align="center">
        <template slot-scope="scope">
          <el-input size="mini" clearable v-model="value9" v-if="scope.$index === 0"></el-input>
          <span v-else>{{ scope.row.price }}</span>
        </template>
      </el-table-column>
      <el-table-column width="75" prop="j" label="销售总价" align="center">
        <template slot-scope="scope">
      ...
      <el-table-column width="75" prop="t" label="客户要求交期" align="center">
        <template slot-scope="scope">
      ...
      <!-- <el-table-column width="75" prop="s" label="采购员" align="center">
        <template slot-scope="scope">
          <el-input size="mini" clearable v-model="value" v-if="scope.$index === 0"></el-input>
          <span v-else>{{ scope.row.s }}</span>
        </template>
      </el-table-column>-->
      <el-table-column width="100" prop="u" label="订单状态" align="center">
        <template slot-scope="scope">
          <el-select size="mini" clearable v-if="scope.$index === 0" v-model="value19">
...
import { exportBuyerOrder, exportOrder } from "@/api/order";
export default {
  props: [
    "total",
    "title",
