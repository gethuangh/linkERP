<template>
  <div class="add-purchase-order">
    ...
    <h2 class="title">采购订单</h2>
    <el-form class="form" label-width="65px" label-position="left">
      <div class="form-row">
        <div class="form-col form-col1">
          <div class="btn btn1">选择关联的采购报价单</div>
        </div>
        <div class="form-col form-col4" style="margin-left: 620px">
          单据编号：
      ...
      <div class="form-row">
        ...
        <div class="form-col form-col4">
          <el-form-item label="收货地址：">
            <el-input size="mini" clearable v-model="name8"></el-input>
          </el-form-item>
        </div>
      </div>
    ...
    <div class="table-wrap">
      ...
      >
        ...
        <el-table-column label="收货仓库" width="105" prop="b"></el-table-column>
        <el-table-column label="原厂型号" width="150" prop="d"></el-table-column>
        <el-table-column label="品牌" align="center" width="100" prop="e"></el-table-column>
        <el-table-column label="数量" align="right" width="60" prop="f"></el-table-column>
        <el-table-column label="批号" align="center" width="60" prop="g"></el-table-column>
        ...
        <el-table-column label="单价" align="right" width="85" prop="j"></el-table-column>
        <el-table-column label="总价" align="right" width="105" prop="k"></el-table-column>
        <el-table-column label="发货日期" align="right" width="100" prop="l"></el-table-column>
        <el-table-column label="佣金" align="right" width="55" prop="m"></el-table-column>
        <el-table-column label="实际单价" align="right" width="85" prop="n"></el-table-column>
        <el-table-column label="应收总价" align="right" width="100" prop="o"></el-table-column>
    ...
    <div class="footer">
      <div class="remark">
        <span>备注：</span>
        <el-input v-model="name13" size="mini"></el-input>
      </div>
      <div class="input-group">
        <div class="input-item">
          <span>制单人</span>
          <el-input size="mini" v-model="name14"></el-input>
        </div>
        <div class="input-item">
          <span>审核人</span>
...
import { addBuyerOrder } from "../../../api/order";
export default {
  data() {
    return {
      name1: "",
  ...
  methods: {
    ...
    iconwenjian() {
      let insertSalesOrder = {
        ...
        supplierId: this.name1,
        supplierLinkmanName: this.name2,
        payment: this.name3,
        payDate: this.name4,
        receiveCompanyName: this.name5,
        receiveCompanyLinkmanName: this.name6,
        phone: this.name7,
        receivingAddress: this.name8,
        buyerCompanyId: this.name9,
      ...
      addBuyerOrder(insertSalesOrderData).then(res => {});
    }
  }
};
</script>
