  ...
  <div class="finance">
    <div>
      <div style="display: flex;align-items: flex-end;">
        <div class="el-button--mini el-button title" style="background: #f0f">应收款</div>
      ...
      <div style="width: 1705px;padding-top:10px;">
        <el-table border size="mini" :data="duesList.list" style="width: 100%">
          ...
          <el-table-column align="center" label="订单日期" width="80">
            <template slot-scope="scope">
              <el-date-picker
                size="mini"
                value-format="yyyy-MM-dd"
          ...
          <el-table-column align="center" label="入库日期" width="80">
            <template slot-scope="scope">
              <el-date-picker
                size="mini"
                value-format="yyyy-MM-dd"
          ...
          <el-table-column align="left" width="190" label="供应商名称">
            <template slot-scope="scope">
          ...
          <el-table-column align="center" width="75" label="单价">
            <template slot-scope="scope">
          ...
          <el-table-column align="center" width="95" label="待付款">
            <template slot-scope="scope">
...
export default {
  ...
  methods: {
    duesListFun(size, num) {
      ...
      duesList(duesListData).then(res => {
        this.duesList = res.result.duesList;
        this.duesList.list.unshift(se);
        this.length = this.duesList.list.length - 1;
        this.num = res.result.duesAmountSum;
        this.total = this.duesList.total;
        console.log(res.result);
      });
    },
    search() {
      this.duesListFun(this.czfy, 1);
    },
    //分页
    xzsizeChange(res) {
      this.duesListFun(res, 1);
      this.czfy = res;
    },
    xzcurrentChange(res) {
      this.duesListFun(this.czfy, res);
    }
  },
  created() {
    this.duesListFun(10, 1);
    //   供应商名称
